...
export const CITY_INTEL = {
  bangkok: {
    ...
    prosCons: {
      ...
      cons: [
        ...
        ['Regulatory Noise', 'Occasional crackdowns on cannabis, late-night entertainment hours, beach access, and foreign-run businesses introduce short-term disruptions expats must learn to absorb.']
      ]
    },
    verdictParagraphs: {
  ...
  'mexico-city': {
    neighborhoods: [
      ...
      { name: 'Roma Norte', rentRatio: 1.15, character: 'Creative + Foodie', oneLineDesc: 'Adjacent to Condesa with denser restaurants, late-night cafes, and galleries; ground-zero for the post-2020 gentrification debate.', bestFor: 'Single remote workers and couples in the 25-40 range.' },
    ...
    risks: [
      ...
      { vector: 'Altitude Adjustment', level: 'MODERATE', assessment: '2,240m elevation affects sleep, cardio capacity, and overall energy levels for the first 2-6 weeks. Plan a softer schedule for month one.' },
  ...
  dubai: {
    ...
    execSummary: [
      ...
      'The counterweight is lifestyle cost. Dubai is not cheap -- rent, schooling, imported groceries for Western diets, and car-dependent commuting stack a premium lifestyle burden that can neutralise the tax saving for households earning under roughly USD 150k. The city is also deeply car-centric, social customs differ from Western Europe outside hotel and licensed venues, and summer (Jun-Sep) is genuinely extreme with 45C+ highs that reshape daily life.',
    ...
    cuisineNotes: 'Dubai\'s food stack is cosmopolitan and expensive: everything from USD 2 shawarma to USD 400 tasting menus exists, but the grocery-shop-at-home-cooking path that works in Bangkok or Lisbon is punitive here because most Western ingredients are imported. The net: eating out is excellent and varied, but cost-controlling a Dubai budget means embracing the Karama/Deira end of the restaurant spectrum, not the Marina end.',
    cultureNotes: 'Dubai runs Sun-Thu as the working week, with Fri-Sat as the weekend (changed in 2022 to a Sat-Sun-adjacent half-day Friday schedule). The city is expat-majority (roughly 85%), English is the professional lingua franca, and it\'s one of the most culturally permissive GCC cities -- but Ramadan customs and the local legal framework still matter and surprise newcomers. Social life is compartmentalised: licensed venues, beach clubs, and home entertaining.',
    risks: [
      ...
      { vector: 'Local Conduct Laws', level: 'LOW', assessment: 'Several social conduct rules differ from Western Europe; a quick orientation read before arrival prevents the most common newcomer surprises.' },
    ...
    prosCons: {
      ...
      cons: [
        ['High Lifestyle Cost', 'Rent + schooling + premium services + car stack a cost base that neutralises tax for mid-income households.'],
        ...
        ['Local Conduct Norms', 'Some social and retail rules differ from Western Europe -- manageable with a quick orientation, but a lifestyle adjustment for newcomers.'],
  ...
  barcelona: {
    ...
    prosCons: {
      pros: [
        ...
        ['Menu-del-Dia Economics', 'Lunch economics (EUR 12-18 for 3 courses) that make the Standard budget genuinely comfortable.'],
  ...
  paris: {
    neighborhoods: [
      ...
      { name: 'Canal Saint-Martin (10e)', rentRatio: 1.05, character: 'Creative + Young', oneLineDesc: 'The canalside young-professional zone: independent cafes, design boutiques, and a tighter cost base than Marais.', bestFor: 'Single remote workers and couples in their late 20s-30s.' },
    ...
    prosCons: {
      ...
      cons: [
        ...
        ['Cost of Entertaining', 'Dinner-out costs run EUR 60-120 per person quickly in central arrondissements.']
      ]
    },
    verdictParagraphs: {
  ...
  prague: {
    ...
    prosCons: {
      pros: [
        ...
        ['Cafe + Pub Culture', 'Daily-life pubs and cafes are genuine social institutions, not tourist traps; among the most affordable in Europe.'],
  ...
  lisbon: {
    ...
    execSummary: [
      ...
      'What still distinguishes Lisbon from peer EU capitals is a unique combination: 2,800+ hours of annual sunshine, ocean and surf 30 minutes from the centre, world-class public transit (Navegante metropolitano EUR 40 unlimited), one of Europe\'s top-10 fibre networks, and a food culture that rewards every euro spent. The trade-offs are real -- housing supply is structurally tight, the bureaucracy of NIF / Social Security registration adds 2-4 weeks of setup friction, and the eastern Atlantic location means longer flights to Asia or the US East Coast than Madrid or Barcelona.',
    ...
    cuisineNotes: 'Lisbon\'s food economics reward eaters: a tasca prato do dia with coffee costs EUR 8-12, premium pasteis de bacalhau and bifana are under EUR 5, and the Time Out Market gathers 20+ chef-led counters under one roof for EUR 12-18 mains. Imported groceries (Asian, US specialties) carry premium pricing -- locals default to Continente or Pingo Doce; expats add Mercado da Ribeira and Comida Independente for specialty.',
    ...
    prosCons: {
      pros: [
        ...
        ['Food Culture', 'EUR 8-12 lunches, Michelin-starred Belcanto, Mercado da Ribeira chef counters, and a Portuguese pastry tradition (pasteis de nata, queijadas) genuinely worth the trip.'],
    ...
    qolScores: {
      ...
      culture:     { score: 8.5, note: 'Fado, surf, world-class design and architecture, Lusophone music and literature; LX Factory and the Berardo, Gulbenkian, MAAT museums anchor the contemporary scene.' },

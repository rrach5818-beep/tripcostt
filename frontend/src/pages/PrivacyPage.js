    ...
    sections: [
      ...
      },
      {
        ...
        content: `
          ...
          <p>We do not collect names, emails or any personally identifiable information through normal browsing.</p>`
      },
      {
        id: 'how-we-use',
      ...
      },
      {
        id: 'data-sharing',
        title: 'Data Sharing',
        content: `<p>We do not sell, rent or trade your personal information to any third party. We may share anonymised, aggregated data (e.g. total page visits) for transparency purposes. If we use analytics providers, they are bound by strict data processing agreements.</p>`
      },
      {
        id: 'security',
        title: 'Data Security',
        content: `<p>We implement appropriate technical measures to protect information against unauthorised access or disclosure. However, no internet transmission is 100% secure. We recommend not sharing sensitive personal data through any online service.</p>`
      },
      {
        id: 'your-rights',
        title: 'Your Rights',
        content: `<p>Depending on your jurisdiction, you may have rights including:</p>
          <ul>
          ...
          <p>To exercise any of these rights, contact us through our official channels.</p>`
      },
      {
        id: 'children',
      ...
      },
      {
        id: 'contact',
        title: 'Contact',
        content: `<p>Questions about this Privacy Policy? Contact us through our official channels and we'll respond as promptly as possible.</p>`
      }
    ]
  }));
}

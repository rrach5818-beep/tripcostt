import{M as r}from"./MainLayout-Dpe6AwD5.js";function l({eyebrow:i,title:o,subtitle:n,sections:t}){const a=t.map(e=>`<a href="#${e.id}" class="lp-toc__link">${e.title}</a>`).join(""),s=t.map(e=>`

import{M as W}from"./MainLayout-Dpe6AwD5.js";import{a as D}from"./cityService-Dc1KzdCT.js";import{B as Q,a as Y}from"./Breadcrumb-CCHdv48W.js";import"./setPageMeta-Be_Dth_8.js";function Z(){const y=D(),$=y.map(p=>`<option value="${p.slug}" data-city="${encodeURIComponent(JSON.stringify(p))}">
      ${p.name}, ${p.country}

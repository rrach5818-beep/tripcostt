import{_ as f}from"./index-DxacdfsZ.js";import{M as b}from"./MainLayout-CBxf94lM.js";import{g as x,a as m}from"./cityService-Dc1KzdCT.js";function w(){const n=x(6),t=m().length,i=n.map((e,p)=>{const l=e.costs.accommodation.center*30+e.costs.food.standard*30+e.costs.transport+e.costs.coworking,g=e.digitalNomad.overallScore>=85?"#10b981":e.digitalNomad.overallScore>=70?"#f59e0b":"#6366f1";return`

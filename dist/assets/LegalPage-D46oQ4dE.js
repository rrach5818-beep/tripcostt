import{M as l}from"./MainLayout-Dpe6AwD5.js";function s({eyebrow:o,title:i,subtitle:n,sections:e}){const a=e.map(t=>`<a href="#${t.id}" class="lp-toc__link">${t.title}</a>`).join(""),r=e.map(t=>`

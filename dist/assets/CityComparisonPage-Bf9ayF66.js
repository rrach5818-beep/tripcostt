import{M as H}from"./MainLayout-Dpe6AwD5.js";import{b as O}from"./cityService-Dc1KzdCT.js";import{s as D,i as T}from"./setPageMeta-Be_Dth_8.js";import{B as U,a as V}from"./Breadcrumb-CCHdv48W.js";function q(p){if(!p)return[];const d=p.split("-vs-");return d.length!==2?[]:d}function X(p){const{cities:d}=p,[i,c]=q(d),e=O(i),o=O(c);if(!e||!o)return H(`

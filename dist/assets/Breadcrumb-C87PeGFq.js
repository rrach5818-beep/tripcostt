import{i as e}from"./setPageMeta-BmQKFz2d.js";const c="https://www.livingcostatlas.com";function b(n){if(!n||n.length<2)return"";const a={"@context":"https://schema.org","@type":"BreadcrumbList",itemListElement:n.map((t,r)=>({"@type":"ListItem",position:r+1,name:t.label,...t.href?{item:`${c}${t.href}`}:{}}))};return setTimeout(()=>e("breadcrumb-jsonld",a),0),`

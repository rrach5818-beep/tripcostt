const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HomePage-u6Jv6E-Z.js","assets/MainLayout-CBxf94lM.js","assets/cityService-Dc1KzdCT.js","assets/DestinationsPage-MAoGqkyh.js","assets/setPageMeta-BmQKFz2d.js","assets/cityRanking-Bc9to1fF.js","assets/countryDB-CrDm3Fkl.js","assets/Breadcrumb-C87PeGFq.js","assets/CityPage-DA_-iCcE.js","assets/CityComparisonPage-tCBVn4HD.js","assets/CalculatorPage-DXEtoPrn.js","assets/NomadPage-CP81hGse.js","assets/AboutPage-CmPTXLEc.js","assets/LegalPage-BSZZKUIK.js","assets/PrivacyPage-CBNs7Qou.js","assets/TermsPage-ByPpGQbH.js","assets/BestCitiesHubPage-1dVYd3t-.js","assets/imageHelper-BIpBZy2g.js","assets/BestCitiesPage-DW14S4iM.js","assets/BestCountriesPage-DQdC50BV.js","assets/EbookPage-CU6UYZ0y.js","assets/EbooksPage-DIxPClM3.js","assets/EbookSuccessPage-CX5WPG8E.js","assets/ResourcesPage-CIn8VwxR.js"])))=>i.map(i=>d[i]);
(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function n(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(a){if(a.ep)return;a.ep=!0;const i=n(a);fetch(a.href,i)}})();let h=null,k=[],_=!1;function C(e,t){h=e,k=t,window.addEventListener("popstate",()=>x()),x()}function A(e){for(const t of k){const n=t.path.split("/"),r=e.split("/");if(n.length!==r.length)continue;const a={};let i=!0;for(let o=0;o<n.length;o++)if(n[o].startsWith(":"))a[n[o].slice(1)]=r[o];else if(n[o]!==r[o]){i=!1;break}if(i)return{route:t,params:a}}return null}async function x(){if(_)return;_=!0;const e=window.location.pathname,t=A(e);try{if(t){const n=await t.route.component(t.params);h.innerHTML=n,t.route.setup&&setTimeout(async()=>{try{await t.route.setup()}catch(r){console.error("Setup error:",r)}},0)}else h.innerHTML=`
  ...
  `,document.head.appendChild(e)}function W(){const e=document.createElement("div");return e.className="lca-np-overlay",e.setAttribute("role","dialog"),e.setAttribute("aria-modal","true"),e.setAttribute("aria-labelledby","lca-np-title"),e.innerHTML=`
  ...
  `,e}function K(e,t){const n=e.querySelector("#lca-np-body");if(!n)return;n.innerHTML=`
    <div class="lca-np-success">
      ...
      <a href="${M}" class="lca-np-dl" id="lca-np-dl-btn" download target="_blank" rel="noopener">
        &#11015; Download the PDF
      </a>
    </div>
  `;const r=n.querySelector("#lca-np-dl-btn");r&&r.addEventListener("click",()=>V())}async function J(e){try{const t=await fetch(H,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify({access_key:j,email:e,subject:"New Living Cost Atlas newsletter signup",from_name:"Living Cost Atlas",source:"lca-newsletter-popup",botcheck:""})}),n=await t.json().catch(()=>({}));return{ok:t.ok&&n.success!==!1,data:n}}catch(t){return{ok:!1,error:t.message}}}function Q(e){const t=e.querySelector(".lca-np-close"),n=e.querySelector("#lca-np-form");function r(){U(),z(),e.style.animation="lcaFadeIn .2s ease-out reverse",setTimeout(()=>e.remove(),180),document.removeEventListener("keydown",a)}function a(i){i.key==="Escape"&&r()}t==null||t.addEventListener("click",r),e.addEventListener("click",i=>{i.target===e&&r()}),document.addEventListener("keydown",a),n==null||n.addEventListener("submit",async i=>{i.preventDefault();const o=e.querySelector("#lca-np-email"),d=e.querySelector(".lca-np-submit"),u=((o==null?void 0:o.value)||"").trim();if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(u)){const p=e.querySelector(".lca-np-err");p&&p.remove();const g=document.createElement("div");g.className="lca-np-err",g.textContent="Please enter a valid email address.",n.appendChild(g);return}if(d.disabled=!0,d.textContent="Sending...",(await J(u)).ok)$(u),B("popup"),K(e,u);else{d.disabled=!1,d.textContent="Send me the guide";const p=document.createElement("div");p.className="lca-np-err",p.textContent="Could not send. Please try again.",n.appendChild(p)}})}function X(){if(document.querySelector(".lca-np-overlay"))return;Y();const e=W();document.body.appendChild(e),Q(e),N(),setTimeout(()=>{var t;return(t=e.querySelector("#lca-np-email"))==null?void 0:t.focus()},400)}function Z(){if(!G())return;let e=!1;function t(){e||(e=!0,X())}const n=setTimeout(t,F);function r(a){a.clientY<=0&&(clearTimeout(n),t(),document.removeEventListener("mouseleave",r))}document.addEventListener("mouseleave",r)}function E(e){typeof gtag=="function"&&gtag("event","page_view",{page_path:e,page_title:document.title,page_location:window.location.href})}function b(e,t={}){typeof gtag=="function"&&gtag("event",e,t)}function ee(){E(window.location.pathname),window.addEventListener("popstate",()=>{setTimeout(()=>E(window.location.pathname),100)}),document.addEventListener("click",e=>{const t=e.target.closest("[data-link]");if(!t)return;const n=t.getAttribute("href");n&&(n==="/calculator"&&b("calculator_open",{source:window.location.pathname}),n.startsWith("/city/")&&b("city_view",{city:n.replace("/city/","")}),n==="/destinations"&&b("destinations_open"),n.startsWith("/compare/")&&b("comparison_view",{cities:n.replace("/compare/","")}))}),document.addEventListener("click",e=>{e.target.closest("#share-btn")&&b("comparison_shared",{page:window.location.pathname})})}function te(){const e=["linear-gradient(135deg, #1e1b4b 0%, #312e81 100%)","linear-gradient(135deg, #064e3b 0%, #065f46 100%)","linear-gradient(135deg, #7c2d12 0%, #9a3412 100%)","linear-gradient(135deg, #1e3a5f 0%, #1e40af 100%)","linear-gradient(135deg, #4a044e 0%, #7e22ce 100%)"];document.addEventListener("error",t=>{const n=t.target;if(n.tagName!=="IMG"||n.dataset.fallbackApplied)return;n.dataset.fallbackApplied="true";const r=(n.src||"").split("").reduce((o,d)=>o+d.charCodeAt(0),0),a=e[r%e.length],i=document.createElement("div");i.style.cssText=`
      width:100%; height:100%;
      background:${a};
      display:flex; align-items:center; justify-content:center;
      color:rgba(255,255,255,0.3); font-size:32px;
    `,i.textContent="🌍",n.parentNode.replaceChild(i,n)},!0)}function ne(){document.addEventListener("click",e=>{const t=e.target.closest("#nav-toggle");if(!t)return;const n=document.getElementById("main-nav");if(!n)return;const r=n.classList.toggle("is-open");t.classList.toggle("is-open",r),t.setAttribute("aria-expanded",String(r))}),document.addEventListener("click",e=>{if(!e.target.closest(".nav__link"))return;const t=document.getElementById("main-nav"),n=document.getElementById("nav-toggle");t&&t.classList.remove("is-open"),n&&(n.classList.remove("is-open"),n.setAttribute("aria-expanded","false"))})}function oe(){const e=document.getElementById("app");if(!e){console.error("App root not found");return}te(),ee(),ne(),C(e,D),Z(),document.addEventListener("click",t=>{const n=t.target.closest("a[data-link]");if(n){t.preventDefault();const r=n.getAttribute("href");window.history.pushState({},"",r),window.dispatchEvent(new PopStateEvent("popstate"))}})}document.addEventListener("DOMContentLoaded",oe);export{c as _,ie as a,se as b,re as c,V as d,B as e,ae as t};

import{s as g,i as m}from"./setPageMeta-BmQKFz2d.js";import{M as x}from"./MainLayout-CBxf94lM.js";import{d as u,e as h}from"./index-Cl71dEOS.js";const n="/ebooks/LivingCostAtlas_FreeGuide_Top10_2026.pdf",b="https://api.web3forms.com/submit",y="1a716176-7bc9-4080-884a-cf88a6394cb6";function k(){g({title:"Research & Resources | Living Cost Atlas",description:"The Digital Nomad Cities Report 2026 and other research tools published by Living Cost Atlas. Data-driven insights for remote workers and expats.",image:"https://www.livingcostatlas.com/og-image.png"}),m({"@context":"https://schema.org","@type":"Report",name:"Digital Nomad Cities Report 2026",datePublished:"2026-04-01",inLanguage:"en",publisher:{"@type":"Organization",name:"Living Cost Atlas",url:"https://www.livingcostatlas.com"},about:"Annual ranking of the most attractive cities for digital nomads and remote workers",url:"https://www.livingcostatlas.com/resources"});const d=`
  ...
  `;return setTimeout(()=>{const a=document.getElementById("res-download-btn");a&&a.addEventListener("click",()=>{u()});const t=document.getElementById("res-notify-form"),l=document.getElementById("res-notify-email"),e=document.getElementById("res-notify-msg"),r=t?t.querySelector(".res-notify__btn"):null;t&&t.addEventListener("submit",async p=>{p.preventDefault();const o=(l.value||"").trim(),c=/^[^\s@]+@[^\s@]+\.[^\s@]+$/;if(e.classList.remove("is-error"),e.textContent="",!c.test(o)){e.classList.add("is-error"),e.textContent="Please enter a valid email address.";return}r.disabled=!0,r.textContent="Sending...";let s=!0;try{const i=await fetch(b,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify({access_key:y,email:o,subject:"LCA -- 2027 report notify-me signup",from_name:"Living Cost Atlas Research",source:"lca-resources-notify",botcheck:""})}),f=await i.json().catch(()=>({}));s=i.ok&&f.success!==!1}catch{s=!1}s?(h("resources-notify"),t.innerHTML='<div class="res-notify__msg" style="color:#059669;font-weight:600">Thanks. We will email you when the 2027 edition is out.</div>'):(r.disabled=!1,r.textContent="Notify me",e.classList.add("is-error"),e.textContent="Could not send. Please try again.")})},0),x(d)}export{k as ResourcesPage,k as default};

import{M as l}from"./MainLayout-BVTdBj1H.js";function s({eyebrow:o,title:i,subtitle:n,sections:e}){const a=e.map(t=>`<a href="#${t.id}" class="lp-toc__link">${t.title}</a>`).join(""),r=e.map(t=>`
  ...
  `).join("");return`
    ...
    <div class="container">
      <div class="lp-layout">
        ...
        <div class="lp-body">${r}</div>
      </div>
    </div>
  `}function c(){return l(s({eyebrow:"Legal",title:"Legal Notice",subtitle:"Important information about Living Cost Atlas and our services.",sections:[{id:"service",title:"Service Provider",content:"<p>Living Cost Atlas is a free online platform providing cost of living information and budget planning tools for digital nomads, remote workers and expats. This website operates for informational purposes only and does not constitute financial, legal or relocation advice.</p>"},{id:"disclaimer",title:"Disclaimer",content:`<p>All information on Living Cost Atlas is provided for general informational purposes. While we strive for accuracy, we make no warranties -- express or implied -- about the completeness, accuracy or reliability of the data presented.</p>
        <p>Any reliance you place on our information is strictly at your own risk. Living Cost Atlas shall not be liable for any direct, indirect or consequential loss arising from your use of this website.</p>`},{id:"data-sources",title:"Data Sources",content:"<p>Cost data is compiled from publicly available databases, government statistical offices, community-contributed information and third-party cost-of-living indexes. We cross-reference multiple sources and update data quarterly. We do not guarantee the accuracy of third-party sources.</p>"},{id:"external-links",title:"External Links",content:"<p>This website may link to external sites not under our control. We have no control over the nature, content or availability of those sites. Inclusion of any link does not imply recommendation or endorsement.</p>"},{id:"copyright",title:"Copyright",content:"<p>All original content on Living Cost Atlas -- including text, structure and interface design -- is the property of Living Cost Atlas and protected under international copyright law. Unauthorised reproduction or distribution is prohibited. City and country images are sourced from Unsplash under their free licence.</p>"},{id:"modifications",title:"Modifications",content:"<p>We reserve the right to modify, suspend or discontinue any aspect of our services at any time without prior notice. Legal terms may be updated at any time; continued use of the service constitutes acceptance of the current version.</p>"},{id:"governing-law",title:"Governing Law",content:"<p>These terms are governed by applicable laws. Any disputes relating to these terms will be subject to the exclusive jurisdiction of the appropriate courts.</p>"}]}))}export{c as LegalPage,c as default};

import{s as g,i as m}from"./setPageMeta-BmQKFz2d.js";import{M as x}from"./MainLayout-CBxf94lM.js";import{d as u,e as h}from"./index-DHxkErcD.js";const n="/ebooks/LivingCostAtlas_FreeGuide_Top10_2026.pdf",b="https://api.web3forms.com/submit",y="1a716176-7bc9-4080-884a-cf88a6394cb6";function k(){g({title:"Research & Resources | Living Cost Atlas",description:"The Digital Nomad Cities Report 2026 and other research tools published by Living Cost Atlas. Data-driven insights for remote workers and expats.",image:"https://www.livingcostatlas.com/og-image.png"}),m({"@context":"https://schema.org","@type":"Report",name:"Digital Nomad Cities Report 2026",datePublished:"2026-04-01",inLanguage:"en",publisher:{"@type":"Organization",name:"Living Cost Atlas",url:"https://www.livingcostatlas.com"},about:"Annual ranking of the most attractive cities for digital nomads and remote workers",url:"https://www.livingcostatlas.com/resources"});const d=`
    <style>
      .res-hero {
      ...
      <article class="res-featured">
        ...
        <div class="res-featured__body">
          ...
          <div class="res-featured__actions">
            <a href="${n}" class="res-btn" id="res-download-btn" download target="_blank" rel="noopener">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
              Download PDF
            </a>
            <a href="${n}" class="res-btn res-btn--ghost" target="_blank" rel="noopener">
              View in browser
            </a>
          </div>
        </div>
  ...
  `;return setTimeout(()=>{const o=document.getElementById("res-download-btn");o&&o.addEventListener("click",()=>{u()});const t=document.getElementById("res-notify-form"),l=document.getElementById("res-notify-email"),e=document.getElementById("res-notify-msg"),r=t?t.querySelector(".res-notify__btn"):null;t&&t.addEventListener("submit",async p=>{p.preventDefault();const s=(l.value||"").trim(),c=/^[^\s@]+@[^\s@]+\.[^\s@]+$/;if(e.classList.remove("is-error"),e.textContent="",!c.test(s)){e.classList.add("is-error"),e.textContent="Please enter a valid email address.";return}r.disabled=!0,r.textContent="Sending...";let i=!0;try{const a=await fetch(b,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify({access_key:y,email:s,name:s,subject:"LCA -- 2027 report notify-me signup",from_name:"Living Cost Atlas Research",message:`New notify-me signup for the 2027 edition.
Email: ${s}
Source: /resources notify-me block`,source:"lca-resources-notify",botcheck:""})}),f=await a.json().catch(()=>({}));i=a.ok&&f.success!==!1}catch{i=!1}i?(h("resources-notify"),t.innerHTML='<div class="res-notify__msg" style="color:#059669;font-weight:600">Thanks. We will email you when the 2027 edition is out.</div>'):(r.disabled=!1,r.textContent="Notify me",e.classList.add("is-error"),e.textContent="Could not send. Please try again.")})},0),x(d)}export{k as ResourcesPage,k as default};

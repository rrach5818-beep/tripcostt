import{M as H}from"./MainLayout-CBxf94lM.js";import{b as O}from"./cityService-DInqR9v8.js";import{s as D,i as T}from"./setPageMeta-BmQKFz2d.js";import{B as U,a as V}from"./Breadcrumb-C87PeGFq.js";function q(p){if(!p)return[];const d=p.split("-vs-");return d.length!==2?[]:d}function X(p){const{cities:d}=p,[i,c]=q(d),e=O(i),o=O(c);if(!e||!o)return H(`

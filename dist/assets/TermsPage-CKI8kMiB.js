import{M as r}from"./MainLayout-BVTdBj1H.js";function l({eyebrow:i,title:o,subtitle:n,sections:t}){const a=t.map(e=>`<a href="#${e.id}" class="lp-toc__link">${e.title}</a>`).join(""),s=t.map(e=>`
  ...
  `).join("");return`
    ...
    <section class="lp-hero">
      <div class="container lp-hero__inner">
        <p class="lp-hero__eyebrow">${i}</p>
        <h1 class="lp-hero__title">${o}</h1>
    ...
    <div class="container">
      <div class="lp-layout">
        ...
        <div class="lp-body">${s}</div>
      </div>
    </div>`}function p(){return r(l({eyebrow:"Terms",title:"Terms of Service",subtitle:"Please read these terms carefully before using Living Cost Atlas.",sections:[{id:"agreement",title:"Agreement to Terms",content:"<p>By accessing or using Living Cost Atlas, you agree to be bound by these Terms of Service. If you do not agree with any part of these terms, please do not use the website.</p>"},{id:"service",title:"Service Description",content:`<p>Living Cost Atlas provides cost of living data, budget planning tools and nomad rankings for informational purposes only. Our services include:</p>
          <ul>
          ...
          <p>Living Cost Atlas is free to use. No account or payment is required to access core features.</p>`},{id:"accuracy",title:"Accuracy of Information",content:`<p>Cost data on Living Cost Atlas is based on research from multiple sources and represents estimates intended for general guidance. Actual costs may vary significantly based on:</p>
          <ul>
          ...
          <p>We strongly recommend conducting your own research and consulting local sources before making financial or relocation decisions.</p>`},{id:"licence",title:"Use Licence",content:`<p>You are granted a limited, non-exclusive licence to access and use Living Cost Atlas for personal, non-commercial purposes. You may not:</p>
          <ul>
            <li>Systematically copy, scrape or redistribute our data</li>
            <li>Use the service for any unlawful purpose</li>
            <li>Attempt to gain unauthorised access to our systems</li>
            <li>Interfere with or disrupt the service or servers</li>
          </ul>`},{id:"disclaimers",title:"Disclaimer of Warranties",content:'<p>Living Cost Atlas is provided on an "as is" and "as available" basis. We make no warranties -- expressed or implied -- including warranties of merchantability or fitness for a particular purpose. We do not warrant that the service will be uninterrupted, error-free or free of harmful components.</p>'},{id:"liability",title:"Limitation of Liability",content:"<p>Living Cost Atlas and its operators shall not be liable for any direct, indirect, incidental or consequential damages arising from your use of the service, including but not limited to financial decisions made based on our data.</p>"},{id:"modifications",title:"Modifications",content:"<p>We reserve the right to modify or discontinue the service at any time without notice. We may update these Terms at any time; continued use constitutes acceptance of the revised terms.</p>"},{id:"governing-law",title:"Governing Law",content:"<p>These terms are governed by applicable laws. Disputes will be subject to the exclusive jurisdiction of the appropriate courts.</p>"},{id:"contact",title:"Contact",content:"<p>Questions about these Terms of Service? Reach us through our official contact channels.</p>"}]}))}export{p as TermsPage,p as default};

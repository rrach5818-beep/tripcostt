/**
 * EbooksPage -- Catalog of all available premium eBooks
    ...
    <a href="/ebook/${b.slug}" data-link class="eb-card">
      ...
      <div class="eb-card__body">
        <div class="eb-card__tags">
          <span class="eb-card__tag">${b.pages} pages</span>
          <span class="eb-card__tag">Nomad ${b.nomadScore}</span>
        </div>
        <h3 class="eb-card__title">${b.city}</h3>
        <p class="eb-card__country">${b.country}</p>
        <div class="eb-card__bottom">
          <span class="eb-card__price">${b.price} EUR</span>

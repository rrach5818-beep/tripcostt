...
const pages = {
  ...
  resources:      lazy(() => import('../pages/ResourcesPage.js')),
};
...
export const routes = [
  ...
  {
    path: '/ebook/:slug',
    component: async (p) => (await pages.ebook.load()).EbookPage(p),
    setup:     async ()  => (await pages.ebook.load()).setupEbookPageInteractivity()
  },
];
